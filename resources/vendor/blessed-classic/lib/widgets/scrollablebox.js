...
const _Scrollable = require('./base/_Scrollable.js')
const Mixin = require('@ject/mixin')
const Node = require('./node.js')
const Box = require('./box.js')
const ScrollableBoxPrototype = require('./prototypes/scrollablebox.js')
...
function ScrollableBox(options = {}) {
  ...
  this.constructScrollable(options)
}
ScrollableBox.prototype.type = 'scrollable-box'
// ScrollableBox.prototype.__proto__ = Box.prototype
Reflect.setPrototypeOf(ScrollableBox, Box.prototype)
Mixin.assign(ScrollableBox.prototype, _Scrollable.prototype)
