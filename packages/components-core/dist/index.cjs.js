...
var colors$1 = require('@pres/util-colors');
var helpers$1 = require('@pres/util-helpers');
...
class ScrollableBox extends Box {
  ...
  constructor(options = {}) {
    ...
    const self = this;
    if (!(this instanceof componentsNode.Node)) return new ScrollableBox(options);
...
class ScrollableElement extends Element$1 {
  /**
   * Element
   */
  constructor(options = {}) {
...
class Layout extends Element$1 {
  ...
  constructor(options = {}) {
    super(options);
    if (!(this instanceof componentsNode.Node)) return new Layout(options);
...
class Line extends Box {
  ...
  constructor(options = {}) {
    ...
    if (!(this instanceof componentsNode.Node)) return new Line(options);
...
class ScrollableText extends ScrollableBox {
  ...
  constructor(options = {}) {
    ...
    if (!(this instanceof componentsNode.Node)) return new ScrollableText(options);
  }
...
class Log$1 extends ScrollableText {
  ...
  constructor(options = {}) {
    ...
    const self = this;
    if (!(this instanceof componentsNode.Node)) return new Log$1(options);
