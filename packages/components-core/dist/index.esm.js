...
class Element$1 extends Node {
  ...
  strWidth(text) {
    ...
    return this.screen.fullUnicode ? unicode$1.strWidth(text) : helpers.dropUnicode(text).length;
  }
  ...
  _listenMouse(el) {
    ...
    this.program.on(MOUSE, function (data) {
      ...
      if (self._needsClickableSort) {
        self.clickable = helpers$1.hsort(self.clickable);
...
export { Box, Element$1 as Element, Layout, Line, Log, Screen, ScrollableBox, ScrollableText, Terminal };
