...
import * as colors$1 from '@pres/util-colors';
import * as helpers$1 from '@pres/util-helpers';
...
class Element$1 extends Node {
  ...
  constructor(options = {}) {
    ...
    super(options);
    this.type = 'element';
    if (options.scrollable && !this._ignore && this.type !== 'scrollable-box') Mixin.assign(this, _Scrollable.prototype);
...
export { Box, Element$1 as Element, Layout, Line, Log$1 as Log, Screen, ScrollableBox, ScrollableElement, ScrollableText, Terminal };
