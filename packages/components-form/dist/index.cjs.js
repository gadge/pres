...
class Input extends Node.Box {
  ...
  constructor(options = {}) {
    super(options);
    if (!(this instanceof Node.Node)) return new Input(options);
    this.type = 'input';
  }
...
class Button extends Input {
  ...
  constructor(options = {}) {
    ...
    const self = this;
    if (!(this instanceof Node.Node)) return new Button(options);
...
class Checkbox extends Input {
  ...
  constructor(options = {}) {
    super(options);
    const self = this;
    if (!(this instanceof Node.Node)) return new Checkbox(options);
...
class FileManager extends componentsData.List {
  ...
  refresh(cwd, callback) {
    ...
    return fs__default['default'].readdir(cwd, function (err, list) {
      ...
      dirs = utilHelpers.helpers.asort(dirs);
      files = utilHelpers.helpers.asort(files);
...
class Form extends Node.Box {
  ...
  constructor(options = {}) {
    ...
    const self = this;
    if (!(this instanceof Node.Node)) return new Form(options);
...
class Prompt extends Node.Box {
  ...
  constructor(options = {}) {
    ...
    this.input = this.readInput;
    this.setInput = this.readInput;
    if (!(this instanceof Node.Node)) return new Prompt(options);
...
class Question extends Node.Box {
  ...
  constructor(options = {}) {
    ...
    if (!(this instanceof Node.Node)) return new Question(options);
    this._.okay = new Button({
      screen: this.screen,
      parent: this,
      top: 2,
...
class RadioButton extends Checkbox {
  ...
  constructor(options = {}) {
    super(options);
    const self = this;
    if (!(this instanceof Node.Node)) return new RadioButton(options);
...
class RadioSet extends Node.Box {
  ...
  constructor(options = {}) {
    super(options);
    if (!(this instanceof Node.Node)) return new RadioSet(options); // Possibly inherit parent's style.
