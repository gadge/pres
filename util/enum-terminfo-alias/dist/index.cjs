...
const BooleanCapabilities = {
  ...
  rows: [ [ 'auto_left_margin', 'bw', 'bw' ], // cub1 wraps from col‐ umn 0 to last column
...
const NumberCapabilities = {
  head: [ 'variable', 'cap-name', 'tcap-code' ],
  rows: [ [ 'columns', 'cols', 'co' ], // number of columns in a line
...
const StringCapabilities = {
  head: [ 'variable', 'cap-name', 'tcap-code' ],
  rows: [ [ 'acs_chars', 'acsc', 'ac' ], // graphics charset pairs, based on vt100
...
exports.BooleanCapabilities = BooleanCapabilities
exports.NumberCapabilities = NumberCapabilities
exports.StringCapabilities = StringCapabilities
