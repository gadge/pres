...
function t(n) {
  return (n == null ? void 0 : n.toString(16).toUpperCase().padStart(6, '0')) ?? DASH6;
}

t.sty = function (n) {
  return (n == null ? void 0 : n.toString(16).padStart(2, '0')) ?? DASH2;
};
...
class Lum {
  ...
  eq(some) {
    return this === some ? true : (this == null ? void 0 : this.m) === (some == null ? void 0 : some.m) && this.f === some.f && this.b === some.b;
  }
