...
import { byteToForeSgra, degrade, byteToBackSgra, rgbToByte, toByte } from '@pres/util-byte-colors';
import { modeToSgra, assignMode, assignModeFrom, styleToMode } from '@pres/util-sgr-mode';
import { BOLD, UNDERLINE, BLINK, INVERSE, HIDE } from '@palett/enum-font-effects';
