...
export {
  BLEND_CACHE, COLOR_MAPPING, COLOR_NAMES, HEX_COLORS, RGBToHex, RGB_COLORS, SPARSE_NAMES, XTERM_COLORS, attrToSgra, blend,
  COLOR_MAPPING as ccolors, HEX_COLORS as colors, convert, reduce as degrade, hexToRGB, match, mixColors, SPARSE_NAMES as ncolors, reduce,
  sattr, sgraToAttr, sattr as styleToAttr, match as toByte, RGB_COLORS as vcolors
}
