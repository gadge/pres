...
var InnerMap__default = /*#__PURE__*/_interopDefaultLegacy(InnerMap);

class Map extends componentsLayout.Canvas {
  constructor(options = {}) {
    super(options);
    const self = this;
    this.on(enumEvents.ATTACH, () => {
      ...
      self.innerMap = new InnerMap__default["default"](opts, self.context);
      self.innerMap.draw();
