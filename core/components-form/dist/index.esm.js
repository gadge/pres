...
import { ENTER, SPACE, TAB, DOWN, BACKSPACE, ESCAPE, UP, RIGHT, RETURN, LEFT } from '@pres/enum-key-names';
...
class Textarea extends Input {
  ...
  _updateCursor(get) {
    ...
    line = Math.min(this._clines.length - 1 - (this.childBase || 0), prevPos.yHi - prevPos.yLo - this.intH - 1); // When calling clearValue() on a full textarea with a border, the first
...
export { Button, Checkbox, FileManager, Form, Input, Prompt, Question, RadioButton, RadioSet, Textarea, Textbox, button, checkbox, fileManager, form, input, prompt, question, radioButton, radioSet, textarea, textbox };
